  ...
  return (
    <section className="relative flex flex-col w-full bg-zinc-200 py-16 isolate">
      <div className="container flex justify-between">
        ...
        <CursorTrigger cursorId="blue">
          <div className="w-[8vw] h-[600px] bg-zinc-300 flex flex-col items-center justify-center">
            Hover me
          </div>
        </CursorTrigger>
        <CursorContent variants={cursorVariants} cursorId="blue">
          <div className="size-16 rounded-full bg-blue-200 font-medium flex items-center justify-center">
            <motion.svg
              xmlns="http://www.w3.org/2000/svg"
              width="32"
              height="32"
        ...
        <CursorTrigger cursorId="green">
          <div className="w-[8vw] h-[600px] bg-zinc-300 flex flex-col items-center justify-center">
            Hover me
          </div>
        </CursorTrigger>
        <CursorContent variants={cursorVariants} cursorId="green">
          <div className="size-16 rounded-full bg-green-200 font-medium flex items-center justify-center">
            <motion.svg
              xmlns="http://www.w3.org/2000/svg"
              width="32"
              height="32"
